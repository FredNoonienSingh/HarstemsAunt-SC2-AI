...
from .combat_flyer import CombatFyler
    ...
    async def engage(self, attack_target:Union[Unit, Point2]) -> None:
        ...
        try:
            if self.air_targets_in_proximity:
                prio_targets:Unit = \
                    self.air_targets_in_proximity.filter(lambda unit: unit.type_id in PRIO_ATTACK_TARGET and\
            ...
            if target.is_flying:
                ...
                if self.can_cast(AbilityId.EFFECT_)
